  ...
  return (
    <div className="p-8 max-w-2xl">
      <div className="mb-8 flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold text-cream">New Testimonial</h1>
      </div>

      <form action={createTestimonial} className="flex flex-col gap-5">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <Field label="Author Name *" name="author" placeholder="Jane Smith" required />
          <Field label="Role / Company *" name="role" placeholder="CMO at Acme Corp" required />
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <Field label="Avatar URL" name="avatarUrl" placeholder="https://…" />
          <Field label="Company Logo URL" name="companyLog" placeholder="https://…" />
        </div>
        <div>
