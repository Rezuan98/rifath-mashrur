...
export const DEFAULT_SETTINGS = {
  ...
  servicesSubtitle: "Full-stack digital marketing capabilities built to work together.",
  ...
  try {
    ...
    if (row) {
      return {
        ...
        tagline: row.tagline,
        workTitle: row.workTitle || DEFAULT_SETTINGS.workTitle,
        workSubtitle: row.workSubtitle,
        servicesTitle: row.servicesTitle || DEFAULT_SETTINGS.servicesTitle,
        servicesSubtitle: row.servicesSubtitle,
        email: row.email,
        phone: row.phone,
